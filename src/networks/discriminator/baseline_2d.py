...
# for any further improvement. This implementation is 2D only. It was extracted from his codebase
...
class BaselineDiscriminator2D(nn.Module):
    def __init__(self, input_nc=1, ndf=64, n_layers=3):
        ...
        """
        super(BaselineDiscriminator2D, self).__init__()
